...
import group5.storage.StorageFileNotFoundException;
import group5.storage.StorageService;
...
public class FileUploadController {
    ...
    public String handleFileUpload(@RequestParam("file") MultipartFile file,
        ...
        redirectAttributes.addFlashAttribute("message", "Tai len thanh cong"+file.getOriginalFilename());
        redirectAttributes.addFlashAttribute("link", "https://drive.google.com/open?id="+file1.getId());
        return "redirect:/";
    }
